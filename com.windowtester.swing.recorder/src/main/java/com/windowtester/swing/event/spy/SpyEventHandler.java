...
//		Tracer.trace(IEventRecorderPluginTraceOptions.SWT_EVENTS, "spy mode toggled to: " + inSpyMode);
    ...
    private UISemanticEvent createInspectionEvent(AWTEvent event) {
        ...
        SemanticWidgetInspectionEvent wEvent =
                new SemanticWidgetInspectionEvent(info,
                        UIContextSwingFactory.createContext()).withWidgetHash(component.hashCode()).atHoverPoint(
                        getCursorPosition());
        return wEvent;
    }
    ...
    private IWidgetIdentifier identifyWidget(
            Component w,
            AWTEvent event) {
    ...
    private IWidgetIdentifier sanityCheck(
            IWidgetIdentifier id,
            AWTEvent event) {
    ...
    static Component getMostSpecificWidgetForEvent(
            Component w,
            AWTEvent event) {
