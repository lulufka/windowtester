...
/**
 * ISemanticEvent is the supertype of all recorder produced events.  There are two types of event: "meta events" such as
 * recorder start and stop and "user events" such as key presses and button selections.
 *
