...
public class RecorderMetaEvent implements IRecorderSemanticEvent {
  ...
  /**
   * Replace the deserialized instance with its associated static object (required for proper
   * serialization).
   *
   ...
   */
  private static final Map<String, IRecorderSemanticEvent> types = new HashMap<>();
