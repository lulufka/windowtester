...
/**
 * Action to iconize application to System Tray uses Java 6 AWT Components
 *
 * @author keertip
 */
public class ToSystemTrayAction implements ActionListener {
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    try {
      ...
      Object tray = trayClass.getMethod("getSystemTray", new Class[0]).invoke(null,
          new Object[0]);

      // tray.add(trayIcon);
      trayClass.getMethod("add", new Class[]{trayIcon.getClass()})
