...
public class WidgetRegistry2 {
     ...
     */
    private final Map _register = new HashMap();

    /**
     * An auxilliary map for reverse lookups
     */
    private final Map/*<WidgetLocator,String>*/ _values = new HashMap();

    /**
     * Associates the specified widget info with the specified key in this registry.
     *
     * @param key  - key with which the specified value is to be associated.
     * @param info - info value to be associated with the specified key.
     * @return previous value associated with specified key, or null if there was no mapping for key.
     */
    public WidgetLocator add(
            String key,
            IWidgetIdentifier info) {
     ...
     * @return the value to which this map maps the specified key, or null if the registry contains no mapping for this
     * key.
     */
     ...
     * @return the associated key, or null if the registry contains no mapping for this value.
     */
    ...
    /**
     * Returns a set view of the mappings contained in this registry. Each element in the returned set is a Map.Entry.
     * The set is backed by the registry, so changes to the map are reflected in the set, and vice-versa. If the
     * registry is modified while an iteration over the set is in progress, the results of the iteration are undefined.
     *
