...
public class URLUtilities {
    ...
    /**
     * Return a URL which is the local equivalent of the give URL. This method is expected to be used with the
     * plug-in-relative URLs returned by IPluginDescriptor, Bundle.getEntry() and Platform.find(). If the specified URL
     * is not a plug-in-relative URL, it is returned as-is. If the specified URL is a plug-in-relative URL of a file
     * (including a .jar archive), it is returned as a locally-accessible URL using "file:" or "jar:file:" protocol
     * (caching the file locally, if required). If the specified URL is a plug-in-relative URL of a directory, an
     * exception is thrown.
     *
