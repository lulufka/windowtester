...
/**
 * Tests whether a locator identifies a widget that is enabled. For example, this can be used to
 * assert that a button is enabled after a particular sequence of user input.
 *
 * <pre>
