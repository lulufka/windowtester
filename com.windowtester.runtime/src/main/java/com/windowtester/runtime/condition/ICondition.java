...
/**
 * An interface used by {@link IConditionMonitor} to test whether a condition has been satisfied. If
 * {@link IConditionMonitor} detects that an {@link ICondition} implements {@link IUICondition},
...
public interface ICondition {
   ...
   * <p>
   * Note that this method is NOT guaranteed to be executed on the UI thread. In fact, it is most
   * likely to be executed on the test thread.
   *
