...
/**
 * An interface used by {@link IConditionMonitor} to test whether a condition has been satisfied. If {@link
 * IConditionMonitor} detects that an {@link ICondition} implements {@link IUICondition}, then {@link IConditionMonitor}
 * calls {@link #testUI(IUIContext)} rather than {@link ICondition#test()}.
 * <p>
