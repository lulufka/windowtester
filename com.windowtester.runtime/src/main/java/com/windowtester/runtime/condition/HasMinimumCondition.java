...
/**
 * Tests whether a locator identifies a widget that has the specified minimum value. For example,
 * this can be used to assert that a SWT slider widget has a particular minimum value.
 *
 * <pre>
