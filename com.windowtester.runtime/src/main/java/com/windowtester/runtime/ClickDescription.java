...
public class ClickDescription implements IClickDescription {
    ...
    public static IClickDescription singleClickAtXY(
            int x,
            int y) {
    ...
    public static IClickDescription create(
            int clicks,
            XYLocator xy,
            int modifierMask) {
        //sanity check mask
    ...
    public static IClickDescription create(
        ...
        {
            return new ClickDescription(clickCount,
                    DEFAULT_CENTER_CLICK,
                    DEFAULT_CENTER_CLICK,
                    DEFAULT_CENTER_CLICK,
                    buttonMask);
    ...
    public static ClickDescription copy(IClickDescription click) {
        return new ClickDescription(click.clicks()).relativeTo(click.relative()).atXY(click.x(), click.y())
