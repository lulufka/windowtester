...
public class ClickDescription implements IClickDescription {
  ...
  public static IClickDescription create(int clickCount, ILocator locator, int buttonMask) {
    ...
    if (locator
        instanceof
        IWidgetLocator) // TODO: change default sentinel to something more expressive than -1s...
    {
      return new ClickDescription(
          clickCount, DEFAULT_CENTER_CLICK, DEFAULT_CENTER_CLICK, DEFAULT_CENTER_CLICK, buttonMask);
    }
    throw new IllegalArgumentException();
  }

  public static ClickDescription copy(IClickDescription click) {
    return new ClickDescription(click.clicks())
        .relativeTo(click.relative())
        .atXY(click.x(), click.y())
