...
abstract class WTRuntimeFactoryReference {
     ...
     */
    protected static boolean isFactoryFor(
            String key,
            String values) {
    ...
    /**
     * The factory wrappered by this reference or <code>null</code> if it has not been instantiated.
     *
     * @see #getFactory()
     */
    ...
    /**
     * Answer the factory, creating it if necessary. If the factory cannot be created, then
     *
