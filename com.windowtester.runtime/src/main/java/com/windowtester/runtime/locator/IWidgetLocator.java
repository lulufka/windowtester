...
/**
 * A locator identifying a widget that may or may not currently exist such as a table item, menu,
 * menu item, text field, etc. Instances are responsible for locating widget(s) that they identify.
 */
