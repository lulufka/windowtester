...
public class ComponentAccessor {
  ...
  private static final Hierarchy _hierarchy = AWTHierarchy.getDefault();
  ...
  /**
   * Parse the string representation of Treepath which is of the form [Root,node1, node2] to return an array of
   * nodenames.
   *
   * @param String input
  ...
  public static String assemblePath(String[] nodeNames) {
    String path = "";
    for (int i = 0; i < nodeNames.length - 1; i++) path = path + nodeNames[i] + "/";
