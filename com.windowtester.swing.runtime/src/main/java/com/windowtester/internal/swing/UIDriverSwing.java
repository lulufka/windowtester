...
public class UIDriverSwing {
    ...
    public Component clickTreeItem(
            int clickCount,
            Component owner,
            String path,
            int mask) {
//		 convert string to TreePath
     ...
     * @return
     */
    public Component clickTextComponent(
    ...
    public Component contextClick(
            Component widget,
            String path) throws WidgetSearchException, ActionFailedException {
     ...
     */
    public Component contextClickTree(
            JTree widget,
            String itemPath,
            String menuPath) throws ComponentMissingException, ActionFailedException {
...
//		else
    ...
    public void waitForWindowShowing(
