...
public class NameOrLabelMatcher extends AbstractMatcher {
  ...
  /**
   * The widget matches if it has the given name (<code>widget.setName("name");</code> or label (for example the human
   * readable text in a button) that matches the specified string.
   *
