...
public class JListLocator extends AbstractPathLocator {
    ...
    /**
     * Create an instance of a locator for JList with the text for the selected item, relative to its parent.
     *
     * @param itemText   the selected item text
    ...
    /**
     * Create an instance of a locator for JList with the text for the selected item, relative to its parent and with
     * relative index.
     *
     * @param itemText   the selected item text
