...
/**
 * A locator for components that have a name. Name is set by using the setName() method of the component.
 * <p>
 * The NamedWidgetLocator can be used for all components. Examples of use: For components such as button or text
 * fields,
 * <p>
 ...
 * <p>
 * ui.click(new JTreeItemLocator("path to node",new NamedWidgetLocator("treeName"))); ui.click(new JListLocator("list
 * element",new NamedWidgetLocator("listName"))); ui.click(new JComboBoxLocator("selection item",new
 * NamedWidgetLocator("comboName")));
 * <p>
 * For a table
 * <p>
