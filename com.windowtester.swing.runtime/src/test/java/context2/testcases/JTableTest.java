...
//
//		locator = ui.click(1,new JTableItemLocator(new Point(2,0)),InputEvent.BUTTON1_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK);
//		table = (JTable)((IWidgetReference)locator).getWidget();
//		model = table.getModel();
...
//		assertEquals(1,table.getSelectedRowCount());
//
//		ui.click(1,new JTableItemLocator(new Point(2,0)),InputEvent.BUTTON1_DOWN_MASK | InputEvent.CTRL_DOWN_MASK);
