...
//		// tree selections
//		tree = doTreeClick(1,"Root/Parent1/Child10/grandChild102","scrollPane1",InputEvent.BUTTON1_DOWN_MASK);
//		TreePath path = tree.getSelectionPath();
//		int[] items = tree.getSelectionRows();
//		assertEquals(1, items.length);
//		assertEquals("grandChild102", path.getLastPathComponent().toString());
//
//		doTreeClick(1,"Root/Parent3/Child30","scrollPane1",InputEvent.BUTTON1_DOWN_MASK);
//		path = tree.getSelectionPath();
//		items = tree.getSelectionRows();
//		assertEquals(1, items.length);
//		assertEquals("Child30", path.getLastPathComponent().toString());
...
//
//		// test shift clicks
//		tree = doTreeClick(1,"Root/Item 0/Node 01","scrollPane2",InputEvent.BUTTON1_DOWN_MASK);
//		doTreeClick(1,"Root/Item 1/Node 10","scrollPane2",InputEvent.BUTTON1_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK);
...
*/
     ...
     * the test
     **/
    public JTree doTreeClick(
            int clickCount,
            String node,
            String scrollPane,
            int mask) throws WidgetSearchException {
        IWidgetLocator locator;
