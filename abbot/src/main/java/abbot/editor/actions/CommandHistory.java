...
public class CommandHistory {
    ...
    /**
     * The index of the most recent command "undone", or the size of the history if the most recent action was
     * "execute".
     */
    ...
    /**
     * Simple wrapper around an existing command to swap the sense of its execute/undo.
     */
    private class CommandComplement implements UndoableCommand {
        private final UndoableCommand cmd;
