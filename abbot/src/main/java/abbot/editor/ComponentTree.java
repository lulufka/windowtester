...
/**
 * Provides a Tree view into a given Hierarchy of components.  Refreshes its display based on changes to the default AWT
 * hierarchy. The selection path is preserved to the extent possible across changes in the hierarchy.
 */
public class ComponentTree extends JTree {
  private Hierarchy hierarchy;
  private final ComponentNode root;
  private final HierarchyMonitor monitor;
  ...
  public void reload(Component comp) {
    ...
    Component selected =
        path == null ? null : ((ComponentNode) path.getLastPathComponent()).getComponent();
    if (node == null) {
      node = root;
    }
