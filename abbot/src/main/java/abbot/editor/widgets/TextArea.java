...
/**
 * A better text area that fires when focus leaves the component, and also selects all the contents when the action is
 * fired to indicate the contents were accepted.
 */
