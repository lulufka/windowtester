...
public class AWT {
     ...
     */
    private static List<Object> disable(
            Object root,
            List<Object> list) {
    ...
    public static int getTertiaryMask() {
        return POPUP_ON_BUTTON2
                ? InputEvent.BUTTON3_DOWN_MASK : InputEvent.BUTTON2_DOWN_MASK;
    }
     ...
     */
    public static MenuItem[] findAWTPopupMenuItems(
            Component parent,
            String path) {
     ...
     */
    public static MenuItem[] findAWTMenuItems(
            Frame frame,
            String path) {
...
//    }
     ...
     */
    public static boolean eventTypeEnabled(
            Component c,
            int id) {
    ...
    public static String getModifiers(InputEvent event) {
        return getModifiers(event.getModifiersEx(),
