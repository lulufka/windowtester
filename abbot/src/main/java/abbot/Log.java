...
public final class Log {
    ...
    private static final ByteArrayOutputStream preInitLog =
     ...
     */
    public static void addDebugClass(
            Class<?> c,
            int depth) {
     ...
     */
    private static void setDebugClass(
            String id,
            boolean enable) {
        if (id.equals("all")) {
            debugAll = enable;
     ...
     */
    private static String trimStackTrace(
            String trace,
            int lines) {
    ...
    private static int getClassStackDepth(Class<?> c) {
        ...
        return depth != null && depth != CLASS_STACK_DEPTH
                ? depth
                : debugStackDepth;
    }
