...
public class ChoiceTester extends ComponentTester {
  ...
  private final int CHOICE_DELAY =
  ...
  private class Listener implements AWTEventListener {
    ...
    public void eventDispatched(AWTEvent e) {
      if (e.getID() == ItemEvent.ITEM_STATE_CHANGED && e.getSource() instanceof Choice) {
        gotChange = ((Choice) e.getSource()).getSelectedIndex() == targetIndex;
      }
    }
  }
