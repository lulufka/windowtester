...
/**
 * Provide actions and assertions for a {@link JList} component. The {@link JList} substructure is a "row", and {@link
...
public class JListTester extends JComponentTester {
  ...
  static String valueToString(JList list, int index) {
    ...
    return string == ArgumentParser.DEFAULT_TOSTRING ? null : string;
  }
