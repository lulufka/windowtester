...
public class JComboBoxTester extends JComponentTester {
    ...
    /**
     * Return an array of strings that represent the combo box list. Note that the current selection might not be
     * included, since it's possible to have a custom (edited) entry there that is not included in the default
     * contents.
     */
