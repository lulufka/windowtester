...
public class WindowTester extends ContainerTester {
    ...
    /**
     * The window's size seems as good an ID as any.  If someone has a bunch of frameless windows floating about, they
     * can come up with a better ID.
     */
     ...
     * Note that this will not necessarily close the window.
     */
