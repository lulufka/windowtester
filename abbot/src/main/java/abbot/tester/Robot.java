...
public class Robot implements AWTConstants {
     ...
     */
    protected boolean postInvocationEvent(
            EventQueue eq,
            Toolkit toolkit,
            long timeout) {
        class RobotIdleLock {
     ...
     * out.
     */
    private boolean waitForComponent(
            Component c,
            long delay) {
     ...
     */
    private Component retargetMouseEvent(
            Component comp,
            int id,
            Point pt) {
        Point where = pt;
     ...
     */
    public void selectAWTMenuItemByLabel(
            Frame frame,
            String path) {
     ...
     */
    public void selectAWTPopupMenuItemByLabel(
            Component invoker,
            String path) {
     ...
     */
    public void selectAWTPopupMenuItem(
            Component invoker,
            String path) {
        try {
    ...
    public void selectPopupMenuItem(
            Component invoker,
     ...
     */
    public Component showPopupMenu(
            Component invoker,
            int x,
            int y) {
        String where = " at (" + x + "," + y + ")";
    ...
    public static String toString(AWTEvent event) {
        ...
        if (event.getID() == KeyEvent.KEY_PRESSED
            ...
            if ((flags & HierarchyEvent.PARENT_CHANGED) != 0) {
                type += bar + "PARENT:"
                        + toString(he.getComponent().getParent());
                bar = "|";
            }
