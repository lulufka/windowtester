...
public class JTreeLocation extends ComponentLocation {
     ...
     */
    private static boolean matchesLastComponent(
            JTree tree,
            Object pattern,
            TreePath path) {
     ...
     */
    public static TreePath findMatchingPath(
            JTree tree,
            TreePath path) {
     ...
     */
    private static TreePath findMatchingPath(
            JTree tree,
            TreePath realPath,
            Object[] input) {
