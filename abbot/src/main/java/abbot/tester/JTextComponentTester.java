...
public class JTextComponentTester extends JComponentTester {
    ...
    public void actionSetCaretPosition(
            Component tc,
            int index) {
     ...
     */
    protected void scrollRectToVisible(
            JComponent c,
            Rectangle rect) {
     ...
     */
    public void actionStartSelection(
            Component comp,
            int index) {
     ...
     */
    public void actionEndSelection(
            Component comp,
            int index) {
