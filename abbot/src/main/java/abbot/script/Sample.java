 ...
 * <blockquote><code>
 * &lt;sample property="..." method="assertXXX" [class="..."]&gt;<br> &lt;sample property="..." method="(get|is|has)XXX"
 * component="component_id"&gt;<br>
 * </code></blockquote>
 * The <b>sample</b> step stores the value found from the given method {@link abbot.tester.ComponentTester} class; the
 * class tag is required for methods based on a class derived from {@link abbot.tester.ComponentTester}; the class tag
 * indicates the {@link java.awt.Component} class, not the Tester class (the appropriate tester class will be derived
 * automatically). The second format indicates a property sample on the given component. In both cases, the result of
