...
public interface UIContext {
  /**
   * @return A {@link ClassLoader} providing access to classes in this context.
   */
  ...
  /**
   * Terminate this context.  All UI components found in the {@link Hierarchy} returned by {@link #getHierarchy()}
   * will be disposed.
   */
  void terminate();
