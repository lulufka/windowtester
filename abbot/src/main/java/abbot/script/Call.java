...
public class Call extends Step {
     ...
     */
    protected Object[] evaluateParameters(
            Method m,
            String[] params)
            throws Exception {
    ...
    protected Object getTarget(Method m) throws Throwable {
        if ((m.getModifiers() & Modifier.STATIC) == 0) {
            try {
                ...
                setScriptError(new InvalidScriptException(
                        "Can't create an object instance of class " + getTargetClassName() + " for non-static method "
                                + m.getName()));
            }
        }
        return null;
