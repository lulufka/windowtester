...
public class ComponentReference
     ...
     */
    private static final ThreadLocal lookupFailures = new ThreadLocal() {
     ...
     * per-lookup) basis.
     */
    private static final ThreadLocal nonShowingMatches = new ThreadLocal() {
        protected synchronized Object initialValue() {
            return new HashMap();
        }
    };
     ...
     */
    private static final ThreadLocal ownsFailureCache = new ThreadLocal() {
        protected synchronized Object initialValue() {
            return Boolean.TRUE;
        }
    };
