 ...
 * <br><br>
 * WindowTester uses a very simple String-matching strategy that takes advantage of Java's regular
 * expression support. String matching can be summarized as follows:
 * <pre>
 ...
 * </pre>
 * <p>
 * A pattern-match is suplemented with a String equality test to guard against (legacy) cases where
 * special wildcard characters are meant to be taken literally in the pattern match.  For instance,
 * the String "(A|B)" has very different interpretations if taken literally versus as a pattern.
 * <br>
 * <br>
